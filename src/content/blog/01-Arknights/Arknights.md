...
tags: [Math, Gaming]
math: true
summary: Employing mathematical modeling to estimate the expected number of pulls required to obtain a single 6-star character in the popular mobile game Arknights
date: "June 16 2023" 
---
<!-- Katex -->
<link
...
![IL Siracusano Event Banner](./IlSiracusano_0.png)
...
![The Arknights Character Pulling Model](./Ark-Model.png)
...
![The Arknights Cumulative Probability Model](./Ark-Cumu-Model.png)
...
![The Arknights Pull Quantile](./Ark-Quantile.png)
